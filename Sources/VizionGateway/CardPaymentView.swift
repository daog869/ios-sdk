...
/// Payment view for collecting and processing card details
...
/// View model for the card payment view
@MainActor
public class CardPaymentViewModel: ObservableObject {
...
#if DEBUG
/// Preview for the card payment view
